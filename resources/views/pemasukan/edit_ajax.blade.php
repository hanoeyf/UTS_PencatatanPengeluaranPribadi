        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input value="{{ $pemasukan->nama }}" type="text" name="nama" id="nama" class="form-control" required>
                    <small id="error-nama" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Jumlah</label>
                    <input value="{{ $pemasukan->jumlah }}" type="number" name="jumlah" id="jumlah" class="form-control" required>
                    <small id="error-jumlah" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Asal Pemasukan</label>
                    <input value="{{ $pemasukan->asal }}" type="text" name="asal" id="asal" class="form-control" required>
                    <small id="error-asal" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Tanggal Pemasukan</label>
                    <input value="{{ $pemasukan->tanggal }}" type="date" name="tanggal" id="tanggal" class="form-control" required>
